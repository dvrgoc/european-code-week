INSERT INTO products (title, short_description, price) VALUES ("T-Shirt for men", "White, short-sleeved with a large black letter T on the front", 20);
INSERT INTO products (title, short_description, price) VALUES ("Hoodie long sleeves", "V-neck Hoodie Casual, antiperspirant", 25);
INSERT INTO products (title, short_description, price) VALUES ("Black Leather Jacket", "Score some style with this black matte leather jacket", 60);
INSERT INTO products (title, short_description, price, promo_price) VALUES ("Waterproof boots", "Want a pair of stylish rain boots", 100, 80);
